...
for i in xrange(num):
    ...
    imagepath = '/opt/yangguan/yushan/oil_dzwl/restful/img/'
    imagepath_post = '/opt/yangguan/yushan/oil_dzwl/restful/img'
    imagepath_out = '/opt/yangguan/yushan/oil_dzwl/restful/out'
    ...
    for file in files:
        if file.endswith('.jpg'):
            ...
            start1 = time.time() 
            r = s.post('http://0.0.0.0:8090/user', headers=headers,data = my_json_data,)
